...
*** set the directory
cd "S:\Joe Lee CPRD data\1stPassCodeListsToCheck\Haem cancer"


**load up aurum file

import delimited "Aurum_Haem_cancer_codelist_040422.txt", clear
...
**load up Gold file:
import delimited "Gold_Haem_cancer_codelist_040422.txt", clear
